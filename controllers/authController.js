...
const domainName = "thenftmarketplace.store";
...
exports.verifiedPasswordToken = catchAsync(async (req, res, next) => {
  ...
  const url = `https://${domainName}/api/v1/users/resetPassword`;
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    const resetURL = `https://${domainName}/api/v1/users/verifiedPasswordToken/${resetToken}`;
    const logoUrl = `${req.protocol}://${req.get("host")}/img/artmintLogo.png`;
